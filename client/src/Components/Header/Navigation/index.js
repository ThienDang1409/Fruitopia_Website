          ...
          >
            ...
            <div className="res-nav">
              ...
              <ul className="list list-inline ml-auto d-flex flex-column flex-md-row align-items-end align-items-md-center">
                  ...
                  {/* Menu items */}
                  {[
                    { to: '/', label: `${t('home')}`, img: HomeImage },
                    { to: '/blog', label: `${t('blogs')}`, img: BlogImage },
                    { to: '/map', label: `${t('mapLocation')}`, img: MapImage },
                    { to: '/license', label: `${t('Intro')}`, img: LicenseImage },
                  ].map((item, index) => (
                    <Link
                      to={item.to}
